...
export class EspiralConReduccionDeRiesgos {
    public static DATA: Methodology = {
        ...
        whoItWorks:'El principio del que se basa este modelo es del modelo Win-Win (ganar-ganar),el'+
        'cual se efectúa a través de negociaciones, en el cual el cliente recibe el producto'+
        'que satisface sus requerimientos y a su vez el conjunto de desarrolladores pueden'+
        'alcanzar presupuestos y fechas de entrega, para lograr esto se hacen varias'+
        'negociaciones al inicio de cada iteración en el espiral, como ya se mencionó'+
        'previamente.',
        graph:'assets/img/espiralconreduccionderiesgos.jpg',
        recommendedProjects: 'recomendable aplicarlo a sistemas que son pequeños, se genera mucho tiempo'+
        'de desarrollo en el sistema, entro otras.',
        sources: null
