...
export class LeanSoftDev {
  public static DATA: Methodology = {
    ...
    disadvantages: [
      ...
      '(BRD) se entiende correctamente. Si usted no tiene una persona con las habilidades correctas analista de negocios, entonces ' +
      'rápidamente podría encontrar esta convertido en una de las causas de la corrupción del alcance.',
      'En magra que permite la especificación de requisitos software (SRS) para evolucionar. Sin embargo, esto causa problemas de su ' +
      'propia. La flexibilidad es grande, pero demasiado pronto dará lugar a un desarrollo que pierde de vista su objetivo original y ' +
      'que nunca termina.'
    ],
    whoItWorks: 'La metodología de desarrollo de software lean (traducción aproximada de lean: «fino» o «esbelto») es una traducción de ' +
      'los principios y las prácticas de la forma de producir lean, hacia el área del desarrollo de software. Inicialmente, originado ' +
