...
export class RapidApplicationDevelopment {
    public static DATA: Methodology = {
        ...
        whoItWorks: 'por objetivo reducir el tiempo de desarrollo de un sistema,'+
        'basándose en la implementación de una versión que sirve como prototipo y después de esto se pasa a',
        'agregar todas las funcionalidades necesarias para satisfacer las necesidades'+
        'y requerimientos que el usuario solicita,'+
        'todo este proceso de integración de funcionalidades se hace de manera iterativa',
        graph : 'assets/img/RAD.jpg',
        recommendedProjects: 'Este modelo no se adecua a sistemas que van a requerir adecuado mantenimiento,'+
        'pues los prototipos que se realizan puede que no sean escalables.'+
        'Otro aspecto negativo es que no se puede medir el progreso del sistema, además'+
        'de que es menos eficiente.',
        sources: [
